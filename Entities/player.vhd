...
entity player is
	...
	port (
		...
		player_x_o  : out integer -- Output for player's X position
	);
end entity player;
...
begin
	...
	movement_proc: process(clk_move)
	begin
	...
	draw_proc: process(player_x, vga_driver_x_i, vga_driver_y_i)
	...
	pipeline_proc: process(clk_draw)
	begin
