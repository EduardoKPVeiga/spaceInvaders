...
package alien_pkg is
	...
	constant QT_ALIENS_PER_LINE	: integer	:= 18;
	constant QT_LINES					: integer	:= 3;
   constant QT_ALIENS				: integer	:= QT_ALIENS_PER_LINE * QT_LINES;
	
	-- Alien physical dimensions and movement
	constant ALIEN_WIDTH		: integer	:= 11; -- Increased for better visibility
	constant ALIEN_HEIGHT		: integer	:= 8; -- Increased for better visibility
